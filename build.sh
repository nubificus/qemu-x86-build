...
{ 
	...
	echo "	-u	Build host with vAccelrt support"
...
do
	...
	;;
        u)
		unikernel=unikraft
		DOCKER_BUILDKIT=1 docker build --network=host -f Dockerfile_rt -t nubificus/unikernels_vaccel-qemu --build-arg "TOKEN=$TOKEN" .
	;;
        r)
		unikernel=rumprun
